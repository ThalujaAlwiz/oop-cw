...
class DatePicker {
    ...
    public DatePicker(JFrame parent) {
        d = new JDialog();
        d.setModal(true);
        String[] header__ = { "SUNDAY", "MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY", "FRIDAY", "SATURDAY" };
        ...
        JButton previousMonth = new
                JButton("<- MONTH");
        previousMonth.addActionListener(ae -> {
            month--;
            displayDate();
        });
        p2.add(previousMonth);
        JButton nextMonth = new
                JButton("MONTH ->");
