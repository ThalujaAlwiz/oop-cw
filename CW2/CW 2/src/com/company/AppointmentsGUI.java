...
public class AppointmentsGUI extends JFrame {
    ...
    private JPanel UpperPanel(){
        ...
        jLabel1.setIcon(new ImageIcon(getClass().getResource("/res/ConsultationIcon.png")));
    ...
    private JScrollPane Table(){
        AppointmentTableModel appointmentTableModel = new
                AppointmentTableModel(ConsultationGUI.patient__List,
                ConsultationGUI.consultation__List);

        JTable table = new
                JTable(appointmentTableModel);
        ...
        table.setFont(new
                Font("Times New Roman", Font.BOLD,13));
        ...
        JMenuItem add = new
                JMenuItem("ADD NEW CONSULTATION ");
        JMenuItem delete = new
                JMenuItem("DELETE SELECTED CONSULTATION ");
